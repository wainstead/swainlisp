...
(fset 'tailerror
      [?\M-x ?s ?h ?e ?l ?l return return ?\M-x ?r ?e ?n ?a ?m ?e ?  ?b ?u ?f ?f ?e ?r return ?c ?t ?e ?r ?r ?o ?r return ?t ?a ?i ?l ?e ?r ?r ?o ?r return])

(fset 'taildebug
      [?\M-x ?s ?h ?e ?l ?l return return ?\M-x ?r ?e ?n ?a ?m ?e ?  ?b ?u ?f ?f ?e ?r return ?c ?t ?d ?e ?g backspace ?b ?u ?g return ?t ?a ?i ?l ?d ?e ?b ?u ?g return])
