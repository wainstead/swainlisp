...
(defun plr-cart-contents (sess_key)
...
(defalias 'sw-open-config 'plr-open-config)


(defun plr-open-cel1 (username album)
...
(defalias 'sw-open-cel1 'plr-open-cel1)


(defun plr-open-bob1 (username album)
...
(defalias 'sw-open-bob1 'plr-open-bob1)
...
(defun plr-order (orders_id)
  "Render the pertinent parts of an plr order."
...
(defalias 'sw-explode 'plr-explode)


(defun plr-cd-bob (username)
...
(defun sw-init-sudo (passwd)
  ...
  (plr-init-shell "sql" "plr")
  (plr-init-shell "www" "sudo su - www")
  (plr-init-shell "root" "sudo -s")
...
(global-set-key "\C-cg" 'plr-insert-svn-gallery)

(defun plr-insert-svn-products ()
  "This is a NO-FRILLS flight -- hold th' CANADIAN BACON!!"
  (interactive)
  (insert "https://svn.myphotoalbum.com/mpa_products/")
)
(global-set-key "\C-cp" 'plr-insert-svn-products)

(defun plr-insert-svn-cart ()
  "Yow!  Now we can become alcoholics!"
  (interactive)
  (insert "https://svn.myphotoalbum.com/mpa_cart/")
)
(global-set-key "\C-cc" 'plr-insert-svn-cart)

(defun plr-insert-svn-ofs ()
  "Yow!  I'm UNEMPLOYED!"
  (interactive)
  (insert "https://svn.myphotoalbum.com/mpa_ofs/")
)
(global-set-key "\C-co" 'plr-insert-svn-ofs)

(defun plr-insert-svn-core ()
  "Yow!  I'm UNEMPLOYED!"
  (interactive)
  (insert "https://svn.myphotoalbum.com/mpa_core/")
)
;; 'r' for 'core' since 'c' is taken by 'cart'
(global-set-key "\C-cr" 'plr-insert-svn-core)

(defun plr-insert-svn-signup ()
  "Yow!  I'm UNEMPLOYED!"
  (interactive)
  (insert "https://svn.myphotoalbum.com/mpa_signup/")
)
;; 'w' for 'wizard'
(global-set-key "\C-cw" 'plr-insert-svn-core)

(defun plr-insert-svn-veracity ()
  "Yow!  I'm UNEMPLOYED!"
  (interactive)
  (insert "https://svn.myphotoalbum.com/mpa_veracity/")
)
;; 'v' for 'veracity'
(global-set-key "\C-cv" 'plr-insert-svn-veracity)
